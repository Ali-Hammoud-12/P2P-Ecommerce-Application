...
import '../../../controller/auth/shopownersignup_controller.dart';
import '../../../core/class/handlingdataview.dart';
import '../../../core/functions/alertexitapp.dart';
import '../../../core/functions/validinput.dart';
import '../../widget/customTextAuth/custombuttonauth.dart';
import '../../widget/customTextAuth/customtextformauth.dart';
...
class ShopOwnerSignUp extends StatelessWidget {
  const ShopOwnerSignUp({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
     Get.put(ShopOwnerSignUpControllerImp());
    return Scaffold(
      appBar: AppBar(
        elevation: 0.0,
        centerTitle: true,
      ...
      body:  WillPopScope(
        ...
        child: GetBuilder<ShopOwnerSignUpControllerImp>(builder: (controller)=> 
