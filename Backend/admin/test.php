...
<head>
  ...
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="controller/assets/vendor/bootstrap/css/bootstrap.min.css">
    <link href="controller/assets/vendor/fonts/circular-std/style.css" rel="stylesheet">
    <link rel="stylesheet" href="controller/assets/libs/css/style.css">
    <link rel="stylesheet" href="controller/assets/vendor/fonts/fontawesome/css/fontawesome-all.css">
    <link rel="stylesheet" href="controller/assets/vendor/charts/chartist-bundle/chartist.css">
    <link rel="stylesheet" href="controller/assets/vendor/charts/morris-bundle/morris.css">
    <link rel="stylesheet" href="controller/assets/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="controller/assets/vendor/charts/c3charts/c3.css">
    <link rel="stylesheet" href="controller/assets/vendor/fonts/flag-icon-css/flag-icon.min.css">
...
<body >
                   ...
                   ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h6 class="card-header">Recent Orders</h6>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="controller/assets/images/product-pic.jpg" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>Product #1 </td>
                                                        <td>id000001 </td>
                                                        <td>20</td>
                                                    ...
                                                    <tr>
                                                        <td>2</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="controller/assets/images/product-pic-2.jpg" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>Product #2 </td>
                                                        <td>id000002 </td>
                                                        <td>12</td>
                                                    ...
                                                    <tr>
                                                        <td>3</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="controller/assets/images/product-pic-3.jpg" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>Product #3 </td>
                                                        <td>id000003 </td>
                                                        <td>23</td>
                                                    ...
                                                    <tr>
                                                        <td>4</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="controller/assets/images/product-pic-4.jpg" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>Product #4 </td>
                                                        <td>id000004 </td>
                                                        <td>34</td>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h6 class="card-header">Customer Acquisition</h6>
                                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h6 class="card-header"> Product Category</h6>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
                                ...
                                <!-- ============================================================== -->
                                <div class="card">
                                    <h6 class="card-header">Top Performing Campaigns</h6>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h6 class="text-muted">New Customer</h6>
                                        <div class="metric-value d-inline-block">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h6 class="text-muted">Visitor</h6>
                                        <div class="metric-value d-inline-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h6 class="card-header">Revenue by Category</h6>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h6 class="card-header"> Total Revenue</h6>
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <!-- ============================================================== -->
                                <div class="card">
                                    <h6 class="card-header"> Sales By Social Source</h6>
                                    <div class="card-body p-0">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <!-- ============================================================== -->
                                <div class="card">
                                    <h6 class="card-header"> Sales By Traffic Source</h6>
                                    <div class="card-body p-0">
                            ...
                            <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h6 class="card-header">Sales By Country Traffic Source</h6>
                                    <div class="card-body p-0">
    ...
    <!-- Optional JavaScript -->
    <!-- jquery 3.3.1 -->
    <script src="controller/assets/vendor/jquery/jquery-3.3.1.min.js"></script>
    <!-- bootstap bundle js -->
    <script src="controller/assets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
    </body>
    </html>
    <!-- slimscroll js -->
    <script src="controller/assets/vendor/slimscroll/jquery.slimscroll.js"></script>
    <!-- main js -->
    <script src="controller/assets/libs/js/main-js.js"></script>
    <!-- chart chartist js -->
    <script src="controller/assets/vendor/charts/chartist-bundle/chartist.min.js"></script>
    <!-- sparkline js -->
    <script src="controller/assets/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <!-- morris js -->
    <script src="controller/assets/vendor/charts/morris-bundle/raphael.min.js"></script>
    <script src="controller/assets/vendor/charts/morris-bundle/morris.js"></script>
    <!-- chart c3 js -->
    <script src="controller/assets/vendor/charts/c3charts/c3.min.js"></script>
    <script src="controller/assets/vendor/charts/c3charts/d3-5.4.0.min.js"></script>
    <script src="controller/assets/vendor/charts/c3charts/C3chartjs.js"></script>
    <script src="controller/assets/libs/js/dashboard-ecommerce.js"></script>